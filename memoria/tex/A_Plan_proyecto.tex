...
En este \textit{sprint} se crearon los modelos de \textit{Random Forest} para recomendaciones a nivel local.
\begin{table}[h!]
	\centering
	\begin{tabular}{C{3cm}|C{3cm}|C{6cm}} 
